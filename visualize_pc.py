...
def visualize_pc(model_id, prediction_path, points, colors, normals, gtsemantic_ids):
...
if __name__ == '__main__':
    ...
    visualize_pc(args.scene_id, args.input_path, cur_points, cur_colors, cur_normals, cur_semantic_ids)
